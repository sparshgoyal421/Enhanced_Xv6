...
main(int argc, char *argv[]) {
  ...
  6a:	7da50513          	addi	a0,a0,2010 # 840 <malloc+0xf0>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 406:	4b650513          	addi	a0,a0,1206 # 8b8 <digits>
 40a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c6:	39ec8c93          	addi	s9,s9,926 # 860 <malloc+0x110>
 ...
 4d4:	3e8b8b93          	addi	s7,s7,1000 # 8b8 <digits>
 ...
 5fa:	26298993          	addi	s3,s3,610 # 858 <malloc+0x108>
        while(*s != 0){
 5fe:	85ee                	mv	a1,s11
