...
main(int argc, char *argv[]) {
  ...
  6e:	7e650513          	addi	a0,a0,2022 # 850 <malloc+0xf4>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d2:	3aac8c93          	addi	s9,s9,938 # 878 <malloc+0x11c>
 ...
 4e0:	3f4b8b93          	addi	s7,s7,1012 # 8d0 <digits>
 ...
 606:	26e98993          	addi	s3,s3,622 # 870 <malloc+0x114>
        while(*s != 0){
 60a:	85ee                	mv	a1,s11
